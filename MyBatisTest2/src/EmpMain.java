...
public class EmpMain {
	...
	public static void main(String[] args) {
		...
		// 저장할 데이터 생성
//		List<EmpDTO> list = Arrays.asList(new EmpDTO(9001, "홍길동1", "SALESMAN", 7698, "2026-04-23", 0, 0, 30),
//				new EmpDTO(9002, "홍길동2", "SALESMAN", 7698, "2026-04-23", 0, 0, 30),
//				new EmpDTO(9003, "홍길동3", "SALESMAN", 7698, "2026-04-23", 0, 0, 30));
//
